...
class PlayerInfoDao(BaseDao):
    ...
    def get_by_id(self, player_id):
        self.cursor.execute('select a.player_id, b.type_id, b.level, a.position_x, a.position_y, a.position_z, a.health, b.max_health'
                            ...
                            'a.player_id=? and a.player_type_id=b.type_id', (player_id,))
        return self.data_to_object(self.cursor.fetchall()[0])

    def insert(self, player_info):
        self.cursor.execute('insert into player_record (player_type_id, health, experience, position_x, position_y, '
                            'position_z) values (?, ?, ?, ?, ?, ?)', (player_info.player_type_id, player_info.health,
    ...
    def delete(self, player_id):
        self.cursor.execute('delete from player_record where player_id=?', (player_id,))
        return self.cursor.rowcount
