...
class MazeInfoDao(BaseDao):
    ...
    def get_by_player_id(self):
        ...
        cursor.execute('select a.maze_id, a.type_id, b.row, b.column, a.maze_json, b.width, b.height from maze_record a, maze_type_config b where '
    ...
    def data_to_object(self, data_tuple):
        if len(data_tuple) > 0:
            return MazeInfo(data_tuple[0],data_tuple[1],data_tuple[2],data_tuple[3],data_tuple[4],data_tuple[5],data_tuple[6])
        return None
